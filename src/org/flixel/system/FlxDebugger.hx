 ...
 */
 class FlxDebugger extends Sprite {
	...
	public function new(Width:Float, Height:Float) {
		...
		_gutter = 8;
		var screenBounds= new Rectangle(_gutter, 15 + _gutter / 2, _screen.x - _gutter * 2, _screen.y - _gutter * 1.5 - 15);
	 ...
	 */
	function onMouseOver(E:MouseEvent = null) {
		hasMouse = true;
	}
	 ...
	 * @param	E	Flash mouse event.
	 */
	function onMouseOut(E:MouseEvent = null) {
		hasMouse = false;
	}
	 ...
	 */
	public function setLayout(Layout:UInt) {
		_layout = Layout;
		resetLayout();
	}

...
public class FlxColor {
	 ...
	 */
	public static function getAnalogousHarmony(color:uint, threshold:int = 30):* {
		var hsv:* = RGBtoHSV(color);
	 ...
	 * @return 	Object containing 3 properties: color1 (the original color), color2 (the warmer analogous color) and color3 (the colder analogous color)
	 */
	public static function getSplitComplementHarmony(color:uint, threshold:int = 30):* {
		var hsv:* = RGBtoHSV(color);
	 ...
	 */
	public static function getTriadicHarmony(color:uint):* {
		var hsv:* = RGBtoHSV(color);
	 ...
	 */
	public static function RGBtoHSV(color:uint):* {
	...
	public static function interpolateColor(color1:uint, color2:uint, steps:uint, currentStep:uint, alpha:uint = 255):uint {
		var src1:* = getRGB(color1);
		var src2:* = getRGB(color2);

		var r:uint = (((Number(src2.red) - Number(src1.red)) * currentStep) / steps) + Number(src1.red);
		var g:uint = (((Number(src2.green) - Number(src1.green)) * currentStep) / steps) + Number(src1.green);
		var b:uint = (((Number(src2.blue) - Number(src1.blue)) * currentStep) / steps) + Number(src1.blue);
	...
	public static function interpolateColorWithRGB(color:uint, r2:uint, g2:uint, b2:uint, steps:uint, currentStep:uint):uint {
		var src:* = getRGB(color);

		var r:uint = (((r2 - Number(src.red)) * currentStep) / steps) + Number(src.red);
		var g:uint = (((g2 - Number(src.green)) * currentStep) / steps) + Number(src.green);
		var b:uint = (((b2 - Number(src.blue)) * currentStep) / steps) + Number(src.blue);
	 ...
	 */
	public static function getRGB(color:uint):* {

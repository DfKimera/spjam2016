...
public class FlxGradient {
	...
	public static function createGradientMatrix(width:int, height:int, colors:Array, chunkSize:int = 1, rotation:int = 90):* {
	...
	public static function createGradientBitmapData(width:int, height:int, colors:Array, chunkSize:int = 1, rotation:int = 90, interpolate:Boolean = true):BitmapData {
		...
		var gradient:* = createGradientMatrix(width, height, colors, chunkSize, rotation);

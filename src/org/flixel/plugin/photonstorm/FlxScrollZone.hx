 ...
 */
 class FlxScrollZone extends FlxBasic {
	static var members:ASDictionary<ASAny,ASAny> = new ASDictionary(true);
	 ...
	 * @see		createZone
	 */
	public static function add(source:FlxSprite, region:Rectangle, distanceX:Float, distanceY:Float, onlyScrollOnscreen:Bool = true, clearRegion:Bool = false) {
		if (members[source]) {
			throw cast("FlxSprite already exists in FlxScrollZone, use addZone to add a new scrolling region to an already added FlxSprite", Error);
		}
	 ...
	 */
	public static function createZone(source:FlxSprite, region:Rectangle, distanceX:Float, distanceY:Float, clearRegion:Bool = false) {
		var texture= new BitmapData(Std.int(region.width), Std.int(region.height), true, 0x00000000);
	 ...
	 */
	public static function updateDrawMatrix(source:FlxSprite, matrix:Matrix, zone:Int = 0) {
	 ...
	 * @param	zone		If the FlxSprite has more than 1 scrolling zone, use this to target which zone to apply the update to (default 0)
	 */
	public static function updateX(source:FlxSprite, distanceX:Float, zone:Int = 0) {
	 ...
	 * @param	zone		If the FlxSprite has more than 1 scrolling zone, use this to target which zone to apply the update to (default 0)
	 */
	public static function updateY(source:FlxSprite, distanceY:Float, zone:Int = 0) {
	 ...
	 */
	public static function startScrolling(source:FlxSprite = null) {
		if (source != null) {
	 ...
	 */
	public static function stopScrolling(source:FlxSprite = null) {
		if (source != null) {

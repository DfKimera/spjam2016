 ...
 */
 class BlurFX extends BaseFX {
	var objects:Array<ASAny>;
	 ...
	 */
	public function create(width:Int, height:Int, blurX:Float, blurY:Float, blurQuality:Int = 1):FlxSprite {
	 ...
	 */
	public function addSprite(source:FlxSprite, autoRemove:Bool = true) {
	 ...
	 */
	public function removeSprite(source:FlxSprite) {
		var i= 0;while (i < objects.length) {

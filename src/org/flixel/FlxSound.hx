 ...
 */
 class FlxSound extends FlxBasic {
	 ...
	 */
	public var amplitude:Float = Math.NaN;
	/**
	 * Just the amplitude of the left stereo channel
	 */
	public var amplitudeLeft:Float = Math.NaN;
	/**
	 * Just the amplitude of the left stereo channel
	 */
	public var amplitudeRight:Float = Math.NaN;
	/**
	 ...
	 */
	var _volume:Float = Math.NaN;
	/**
	 * Internal tracker for total volume adjustment.
	 */
	var _volumeAdjust:Float = Math.NaN;
	/**
	...
	public function play(ForceRestart:Bool = false) {
		...
		if (ForceRestart) {
			var oldAutoDestroy= autoDestroy;
			autoDestroy = false;
			stop();
	 ...
	 * @private
	 */
	@:flash.property public var volume(get,set):Float;
...
return Volume;
	 ...
	 */
	@:allow(org.flixel) function updateTransform() {

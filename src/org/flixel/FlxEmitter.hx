 ...
 */
 class FlxEmitter extends FlxGroup {
	 ...
	 */
	public var minRotation:Float = Math.NaN;
	/**
	 * The maximum possible angular velocity of a particle.  The default value is 360.
	 * NOTE: rotating particles are more expensive to draw than non-rotating ones!
	 */
	public var maxRotation:Float = Math.NaN;
	/**
	 * Sets the <code>acceleration.y</code> member of each particle to this value on launch.
	 */
	public var gravity:Float = Math.NaN;
	/**
	 ...
	 */
	public var frequency:Float = Math.NaN;
	/**
	 * How long each particle lives once it is emitted.
	 * Set lifespan to 'zero' for particles to live forever.
	 */
	public var lifespan:Float = Math.NaN;
	/**
	 * How much each particle should bounce.  1 = full bounce, 0 = no bounce.
	 */
	public var bounce:Float = Math.NaN;
	/**
	 * Set your own particle class type here.
	 * Default is <code>FlxParticle</code>.
	 */
	public var particleClass:Class<Dynamic>;
	/**
	 * Internal helper for deciding how many particles to launch.
	 */
	var _quantity:UInt = 0;
	/**
	 ...
	 */
	public function makeParticles(Graphics:Class<Dynamic>, Quantity:UInt = 50, BakedRotations:UInt = 16, Multiple:Bool = false, Collide:Float = 0.8):FlxEmitter {
		maxSize = Quantity;
	 ...
	 */
	public function start(Explode:Bool = true, Lifespan:Float = 0, Frequency:Float = 0.1, Quantity:UInt = 0) {
		revive();
		visible = true;
		on = true;
	...
	public function emitParticle() {
		var particle= Std.downcast(recycle(FlxParticle) , FlxParticle);
	 ...
	 *
	 * @param	obj		The <code>FlxObject</code> that you want to sync up with.
	 */
	public function at(obj:FlxObject) {
		obj.getMidpoint(_point);

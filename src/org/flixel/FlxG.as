...
public class FlxG {
	 ...
	 */
	static public function watch(AnyObject:*, VariableName:String, DisplayName:String = null):void {
		if ((_game != null) && (_game._debugger != null)) {
	 ...
	 * @param	VariableName	The name of the variable you want to watch, in quotes, as a string: e.g. "speed" or "health".
	 */
	static public function unwatch(AnyObject:*, VariableName:String = null):void {
		if ((_game != null) && (_game._debugger != null)) {
	 ...
	 */
	static public function getRandom(Objects:Array, StartIndex:uint = 0, Length:uint = 0):* {
		if (Objects != null) {
			var l:uint = Length;

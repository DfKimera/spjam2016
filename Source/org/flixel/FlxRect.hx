 ...
 */
 class FlxRect {
	 ...
	 */
	@:flash.property public var left(get,never):Float;
function  get_left():Float {
	 ...
	 */
	@:flash.property public var right(get,never):Float;
function  get_right():Float {
	 ...
	 */
	@:flash.property public var top(get,never):Float;
function  get_top():Float {
	 ...
	 */
	@:flash.property public var bottom(get,never):Float;

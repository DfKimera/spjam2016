 ...
 */
 class FlxCamera extends FlxBasic {
	 ...
	 */
	static public inline final STYLE_LOCKON:UInt = 0;
	/**
	 * Camera "follow" style preset: camera deadzone is narrow but tall.
	 */
	static public inline final STYLE_PLATFORMER:UInt = 1;
	/**
	 * Camera "follow" style preset: camera deadzone is a medium-size square around the focus object.
	 */
	static public inline final STYLE_TOPDOWN:UInt = 2;
	/**
	 * Camera "follow" style preset: camera deadzone is a small square around the focus object.
	 */
	static public inline final STYLE_TOPDOWN_TIGHT:UInt = 3;

	/**
	 * Camera "shake" effect preset: shake camera on both the X and Y axes.
	 */
	static public inline final SHAKE_BOTH_AXES:UInt = 0;
	/**
	 * Camera "shake" effect preset: shake camera on the X axis only.
	 */
	static public inline final SHAKE_HORIZONTAL_ONLY:UInt = 1;
	/**
	 * Camera "shake" effect preset: shake camera on the Y axis only.
	 */
	static public inline final SHAKE_VERTICAL_ONLY:UInt = 2;

	/**
	 * While you can alter the zoom of each camera after the fact,
	 * this variable determines what value the camera will start at when created.
	 */
	static public var defaultZoom:Float = Math.NaN;
	 ...
	 * Internal, used to render buffer to screen space.
	 */
	@:allow(org.flixel) var _flashSprite:Sprite;
	/**
	 * Internal, used to render buffer to screen space.
	 */
	@:allow(org.flixel) var _flashOffsetX:Float = Math.NaN;
	/**
	 * Internal, used to render buffer to screen space.
	 */
	@:allow(org.flixel) var _flashOffsetY:Float = Math.NaN;
	/**
	 * Internal, used to render buffer to screen space.
	 */
	 ...
	 */
	var _fxFlashColor:UInt = 0;
	/**
	 * Internal, used to control the "flash" special effect.
	 */
	var _fxFlashDuration:Float = Math.NaN;
	/**
	 * Internal, used to control the "flash" special effect.
	 */
	var _fxFlashComplete:ASFunction;
	/**
	 * Internal, used to control the "flash" special effect.
	 */
	var _fxFlashAlpha:Float = Math.NaN;
	/**
	 * Internal, used to control the "fade" special effect.
	 */
	var _fxFadeColor:UInt = 0;
	/**
	 * Internal, used to control the "fade" special effect.
	 */
	var _fxFadeDuration:Float = Math.NaN;
	/**
	 * Internal, used to control the "fade" special effect.
	 */
	var _fxFadeComplete:ASFunction;
	/**
	 * Internal, used to control the "fade" special effect.
	 */
	var _fxFadeAlpha:Float = Math.NaN;
	/**
	 * Internal, used to control the "shake" special effect.
	 */
	var _fxShakeIntensity:Float = Math.NaN;
	/**
	 * Internal, used to control the "shake" special effect.
	 */
	var _fxShakeDuration:Float = Math.NaN;
	/**
	 * Internal, used to control the "shake" special effect.
	 */
	var _fxShakeComplete:ASFunction;
	/**
	 * Internal, used to control the "shake" special effect.
	 */
	 ...
	 */
	public function follow(Target:FlxObject, Style:UInt = STYLE_LOCKON) {
		target = Target;
		var helper:Float;
		switch (Style) {
	 ...
	 */
	public function focusOn(Point:FlxPoint) {
	 ...
	 */
	public function setBounds(X:Float = 0, Y:Float = 0, Width:Float = 0, Height:Float = 0, UpdateWorld:Bool = false) {
		if (bounds == null) {
			bounds = new FlxRect();
		}
	 ...
	 */
	public function flash(Color:UInt = 0xffffffff, Duration:Float = 1, OnComplete:ASFunction = null, Force:Bool = false) {
		if (!Force && (_fxFlashAlpha > 0.0)) {
			return;
		}
		_fxFlashColor = Color;
		if (Duration <= 0) {
			Duration = ASCompat.MIN_FLOAT;
		}
	 ...
	 * @param	Force		Force the effect to reset.
	 */
	public function fade(Color:UInt = 0xff000000, Duration:Float = 1, OnComplete:ASFunction = null, Force:Bool = false) {
		...
		_fxFadeAlpha = ASCompat.MIN_FLOAT;
	}
	 ...
	 */
	public function shake(Intensity:Float = 0.05, Duration:Float = 0.5, OnComplete:ASFunction = null, Force:Bool = true, Direction:UInt = SHAKE_BOTH_AXES) {
	 ...
	 * @private
	 */
	@:flash.property public var zoom(get,set):Float;
...
return Zoom;
	 ...
	 * @private
	 */
	@:flash.property public var alpha(get,set):Float;
...
function  set_alpha(Alpha:Float):Float{
	 ...
	 * @private
	 */
	@:flash.property public var angle(get,set):Float;
function  get_angle():Float {
		return _flashSprite.rotation;
	}
function  set_angle(Angle:Float):Float{
		return _flashSprite.rotation = Angle;
	}
	 ...
	 * @private
	 */
	@:flash.property public var color(get,set):UInt;
function  get_color():UInt {
		return _color;
	}
function  set_color(Color:UInt):UInt{
		_color = Color;
		var colorTransform= _flashBitmap.transform.colorTransform;
...
return Color;
	 ...
	 * @private
	 */
	@:flash.property public var antialiasing(get,set):Bool;
...
function  set_antialiasing(Antialiasing:Bool):Bool{
	 ...
	 */
	public function fill(Color:UInt, BlendAlpha:Bool = true) {
	 ...
	 */
	@:allow(org.flixel) function drawFX() {

 ...
 */
 class FlxSpecialFX extends FlxBasic {
	 ...
	 */
	public static function startFX(source:Class<Dynamic> = null) {
		if (source != null) {
	 ...
	 */
	public static function stopFX(source:Class<Dynamic> = null) {
		if (source != null) {
	 ...
	 */
	public static function isActive(source:Class<Dynamic>):Bool {
		if (members[source]) {
	 ...
	 */
	public static function remove(source:ASAny):Bool {
		if (members[source]) {

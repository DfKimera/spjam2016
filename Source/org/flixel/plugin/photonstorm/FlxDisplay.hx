...
import org.flixel.*;
 ...
 class FlxDisplay {
	 ...
	 */
	public static function alphaMask(source:Class<Dynamic>, mask:Class<Dynamic>, output:FlxSprite):FlxSprite {
	 ...
	 */
	public static function screenWrap(source:FlxSprite) {
		if (source.x < 0) {
			source.x = FlxG.width;
	 ...
	 */
	public static function rotateClockwise(source:FlxSprite) {
	}
	 ...
	 */
	public static function space(sprites:Array<ASAny>, startX:Int, startY:Int, horizontalSpacing:Int = 0, verticalSpacing:Int = 0, spaceFromBounds:Bool = false) {
		var prevWidth= 0;
		var prevHeight= 0;

		var i= 0;while (i < sprites.length) {

 ...
 class FlxControl extends FlxBasic {
	...
	public static function create(source:FlxSprite, movementType:Int, stoppingType:Int, player:Int = 1, updateFacing:Bool = false, enableArrowKeys:Bool = true):FlxControlHandler {
		...
		if (player == 1) {
			...
			var newControlHandler= new FlxControlHandler(source, movementType, stoppingType, updateFacing, enableArrowKeys);
...
var handler:FlxControlHandler  = _tmp_;
	 ...
	 */
	public static function start(source:FlxControlHandler = null) {
		if (source != null) {
...
var handler:FlxControlHandler  = _tmp_;
	 ...
	 */
	public static function stop(source:FlxControlHandler = null) {
		if (source != null) {

 ...
 */
 class WatchEntry {
	 ...
	 */
	public function new(Y:Float, NameWidth:Float, ValueWidth:Float, Obj:ASAny, Field:String, Custom:String = null) {
		editing = false;
	 ...
	 */
	public function updateWidth(NameWidth:Float, ValueWidth:Float) {
	...
	public function updateValue():Bool {
		...
		valueDisplay.text = Std.string(object[field]);
		return true;
	}
	 ...
	 */
	public function onMouseUp(FlashEvent:MouseEvent) {
		editing = true;
	 ...
	 */
	public function onKeyUp(FlashEvent:KeyboardEvent) {

 ...
 */
 class Input {
	 ...
	 * @private
	 */
	@:allow(org.flixel.system.input) var _lookup:ASAny;
	/**
	 * @private
	 */
	@:allow(org.flixel.system.input) var _map:Array<ASAny>;
	/**
	 * @private
	 */
	@:allow(org.flixel.system.input) static inline final _total:UInt = 256;
	 ...
	 */
	public function record():Array<ASAny> {
		var data:Array<ASAny> = null;
		var i:UInt = 0;
		while (i < _total) {
			var o:ASAny = _map[i++];
	 ...
	 */
	public function playback(Record:Array<ASAny>) {
		var i:UInt = 0;
	 ...
	 */
	function addKey(KeyName:String, KeyCode:UInt) {

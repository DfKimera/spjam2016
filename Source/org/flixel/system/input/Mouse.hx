 ...
 */
 class Mouse extends FlxPoint {
	 ...
	 */
	@:flash.property public var visible(get,never):Bool;
function  get_visible():Bool {
	 ...
	 */
	public function handleMouseDown(FlashEvent:MouseEvent) {
		if (_current > 0) {
			_current = 1;
		} else {
			_current = 2;
	 ...
	 * @param	FlashEvent	A <code>MouseEvent</code> object.
	 */
	public function handleMouseUp(FlashEvent:MouseEvent) {
		if (_current > 0) {
			_current = -1;
		} else {
			_current = 0;
	 ...
	 * @param	FlashEvent	A <code>MouseEvent</code> object.
	 */
	public function handleMouseWheel(FlashEvent:MouseEvent) {
	 ...
	 */
	public function playback(Record:MouseRecord) {

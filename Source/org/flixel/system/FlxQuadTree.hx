 ...
 */
 class FlxQuadTree extends FlxRect {
	 ...
	 */
	static public inline final A_LIST:UInt = 0;
	/**
	 * Flag for specifying that you want to add an object to the B list.
	 */
	static public inline final B_LIST:UInt = 1;
	 ...
	 * Internal, governs and assists with the formation of the tree.
	 */
	var _leftEdge:Float = Math.NaN;
	/**
	 * Internal, governs and assists with the formation of the tree.
	 */
	var _rightEdge:Float = Math.NaN;
	/**
	 * Internal, governs and assists with the formation of the tree.
	 */
	var _topEdge:Float = Math.NaN;
	/**
	 * Internal, governs and assists with the formation of the tree.
	 */
	var _bottomEdge:Float = Math.NaN;
	/**
	 * Internal, governs and assists with the formation of the tree.
	 */
	var _halfWidth:Float = Math.NaN;
	/**
	 * Internal, governs and assists with the formation of the tree.
	 */
	var _halfHeight:Float = Math.NaN;
	/**
	 * Internal, governs and assists with the formation of the tree.
	 */
	var _midpointX:Float = Math.NaN;
	/**
	 * Internal, governs and assists with the formation of the tree.
	 */
	var _midpointY:Float = Math.NaN;
	 ...
	 * Internal, used to reduce recursive method parameters during object placement and tree formation.
	 */
	static var _objectLeftEdge:Float = Math.NaN;
	/**
	 * Internal, used to reduce recursive method parameters during object placement and tree formation.
	 */
	static var _objectTopEdge:Float = Math.NaN;
	/**
	 * Internal, used to reduce recursive method parameters during object placement and tree formation.
	 */
	static var _objectRightEdge:Float = Math.NaN;
	/**
	 * Internal, used to reduce recursive method parameters during object placement and tree formation.
	 */
	static var _objectBottomEdge:Float = Math.NaN;

	/**
	 * Internal, used during tree processing and overlap checks.
	 */
	static var _list:UInt = 0;
	/**
	 * Internal, used during tree processing and overlap checks.
	 */
	static var _useBothLists:Bool = false;
	/**
	 * Internal, used during tree processing and overlap checks.
	 */
	static var _processingCallback:ASFunction;
	/**
	 * Internal, used during tree processing and overlap checks.
	 */
	static var _notifyCallback:ASFunction;
	/**
	 * Internal, used during tree processing and overlap checks.
	 */
	 ...
	 */
	static var _objectHullX:Float = Math.NaN;
	/**
	 * Internal, helpers for comparing actual object-to-object overlap - see <code>overlapNode()</code>.
	 */
	static var _objectHullY:Float = Math.NaN;
	/**
	 * Internal, helpers for comparing actual object-to-object overlap - see <code>overlapNode()</code>.
	 */
	static var _objectHullWidth:Float = Math.NaN;
	/**
	 * Internal, helpers for comparing actual object-to-object overlap - see <code>overlapNode()</code>.
	 */
	static var _objectHullHeight:Float = Math.NaN;

	/**
	 * Internal, helpers for comparing actual object-to-object overlap - see <code>overlapNode()</code>.
	 */
	static var _checkObjectHullX:Float = Math.NaN;
	/**
	 * Internal, helpers for comparing actual object-to-object overlap - see <code>overlapNode()</code>.
	 */
	static var _checkObjectHullY:Float = Math.NaN;
	/**
	 * Internal, helpers for comparing actual object-to-object overlap - see <code>overlapNode()</code>.
	 */
	static var _checkObjectHullWidth:Float = Math.NaN;
	/**
	 * Internal, helpers for comparing actual object-to-object overlap - see <code>overlapNode()</code>.
	 */
	static var _checkObjectHullHeight:Float = Math.NaN;
	...
	public function new(X:Float, Y:Float, Width:Float, Height:Float, Parent:FlxQuadTree = null) {
		...
		if (Parent != null) {
			...
			_min = Std.int((width + height) / (2 * divisions));
		}
	 ...
	 */
	public function load(ObjectOrGroup1:FlxBasic, ObjectOrGroup2:FlxBasic = null, NotifyCallback:ASFunction = null, ProcessCallback:ASFunction = null) {
	 ...
	 */
	public function add(ObjectOrGroup:FlxBasic, List:UInt) {
		_list = List;
		if (Std.is(ObjectOrGroup , FlxGroup)) {
			var i:UInt = 0;
			var basic:FlxBasic;
			var members= Std.downcast(ObjectOrGroup , FlxGroup).members;
			var l:UInt = Std.int(Std.downcast(ObjectOrGroup , FlxGroup).length);
			while (i < l) {
				...
				if ((basic != null) && basic.exists) {
					if (Std.is(basic , FlxGroup)) {
						...
						_object = Std.downcast(basic , FlxObject);
			...
			_object = Std.downcast(ObjectOrGroup , FlxObject);
			if (_object.exists && _object.allowCollisions != 0) {
				_objectLeftEdge = _object.x;
				_objectTopEdge = _object.y;
				_objectRightEdge = _object.x + _object.width;
